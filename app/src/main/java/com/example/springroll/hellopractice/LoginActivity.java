package com.example.springroll.hellopractice;
...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private Button mUserSignInButton, mUserSignUpButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mUserSignUpButton = (Button)findViewById(R.id.user_sign_up_button);
